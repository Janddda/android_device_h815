...
BOARD_BLUEDROID_VENDOR_CONF := device/lge/h815/bluetooth/libbt_vndcfg.txt
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/lge/h815/bluetooth

# RIL
BOARD_RIL_CLASS := ../../../device/lge/h815/ril/
